...
const TradeCapabilities = () => {
    return (
        <div className='mb-6'>
            <h1 className='text-2xl text-primary font-semibold text-left mb-4'>Trade Capabilities</h1>

            <div className='border border-[#0029FF4D] rounded-md'>
                <h1 className='text-left font-semibold text-black text-xl p-3 md:px-6 pt-6'>Main Market & Product</h1>
                    ...
                    <table className='mainTable w-full text-left'>
                        ...
                        <tbody className='mainTbody h-12'>
                            <tr className='mainTr border-t pt-1 md:pt-0 md:border-none border-primary'>
                                ...
                                <td className='mainTd bg-gray-200 md:bg-white my-1 px-3 md:px-6 py-2' data-label="Verified">-</td>
                            </tr>
                ...
                <h1 className='text-left font-semibold text-black text-xl p-3 md:px-6 pt-6'>Trade Ability</h1>
                <div className='grid md:grid-cols-2 gap-6 p-3 md:p-6'>
                    <div className=''>
                        <div className='grid grid-cols-5 mb-4'>
                            <h1 className='col-span-2 text-left text-gray-500 text-md font-semibold'>Language Spoken:</h1>
                            <h1 className='col-span-3 text-left text-gray-500 text-md'>English, Chinese, Spanish, Japanese, Arbic, French, Hindi, Italian</h1>
                        </div>
                        <div className='grid grid-cols-5 mb-4'>
                            <h1 className='col-span-2 text-left text-gray-500 text-md font-semibold'>No of Employees in Trade Department:</h1>
                            <h1 className='col-span-3 text-left text-gray-500 text-md'>10-15 People</h1>
                        </div>
                        <div className='grid grid-cols-5 mb-4'>
